...
export const ConnectedWalletButton = ({
  ...
  if (!connected) {
    return (
      <Column css={{ paddingBottom: '0' }}>
        <Button onClick={onConnect} size="large" variant="primary" style={{ backgroundColor: '#FAD333', color: 'black' }} {...props}>
          {isMobile ? 'Connect' : 'Connect Keplr'}
        </Button>
      </Column>
    )
  }
  ...
  return (
    <StyledWalletButton {...props} role="button">
      <IconWrapper size="medium" css={{ color: '#FFFFFF' }} icon={<Wallet />} />
      <div data-content="">
