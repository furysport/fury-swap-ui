...
export const AssetsList = ({ onActionClick }) => {
  ...
  return (
    <>
      ...
      >
        {/* Ensure your wallet holds at least 0.1 FURY for IBC transfers. This is necessary to cover potential network transaction fees and to ensure the transfer is processed smoothly. Claim the faucet <a href='https://faucet.fury.xyz' target='_blank' style={{color: '#8f8'}}>here</a> */}
      </Text>
    </>
  )
}
